...
public class Ex32DtoTest2 {
	...
	public void inputDate(String[] datas) {
		// System.out.println(datas[0]);
		// "김밥,100,100,100" 이런 문자열을 콤마 기준으로 분리
	...
	public static void main(String[] args) {
		...
		dates[0] = "김밥,100,100,100";
		dates[1] = "주먹밥,80,75,88";
		dates[2] = "비빔밥,77,88,80";
		
		
		Ex32DtoTest2 test2 = new Ex32DtoTest2();
		test2.inputDate(dates);
		test2.displayDate();
