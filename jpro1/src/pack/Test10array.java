...
public class Test10array {
	public static void main(String[] args) {
		// 배열(array) : 성격과 크기가 일치하는 복수 개의 기억장소에 대해 대표명 하나를 주고
		// 첨자(index)로 각 기억장소를 구분 why? 반복처리가 효과적
		int aa; // 기억장소 한 개 선언
		// int ar[]; // 배열로 선언 int []ar; 앞에다 써도 개의치 않는다
		// ar = new int[5];
		int ar[] = new int[5];
		...
		System.out.println("가변 배열 : 행 마다 요소의 갯수가 동적");
